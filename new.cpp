...
#include "C:\Users\Andrey\Documents\AHRSRepo\MadgwickAHRS\newHPP.hpp"
#include <math.h>
#include <stdio.h>
#include <fstream>
#include <iostream>
...
void newHPP::update(float gx, float gy, float gz, float ax, float ay, float az, float mx, float my, float mz) {
	float recipNorm;
	float s0, s1, s2, s3;
...
void newHPP::updateIMU(float gx, float gy, float gz, float ax, float ay, float az) {
	float recipNorm;
	float s0, s1, s2, s3;
	float qDot1, qDot2, qDot3, qDot4;
...
// -----
void newHPP::test(SensorData data){
    // Acquire latest sensor data
        ...
        update(data.gyroX, data.gyroY, data.gyroZ, data.accelX, data.accelY, data.accelZ, data.magX, data.magY, data.magZ);
        ...
        printf("Roll %0.2f, Pitch %0.2f, Yaw %0.2f\n",
               newHPP::getRoll(), newHPP::getPitch(), newHPP::getYaw());
...
int main() {
    ...
    outputFile.open("outputFileNew.txt");
